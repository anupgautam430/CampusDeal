...
namespace CampusDeal.DataAccess.Migrations
{
    ...
    public partial class initialMigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "products",
                columns: new[] { "Id", "CategoryId", "Description", "ImageUrl", "PNO", "Price", "PriceTotal", "Seller", "Title" },
                values: new object[,]
                {
                    { 1, 1, "the maths book", "", "A01", 400.0, 400.0, "john wick", "Book" },
                    { 2, 1, "the maths notebook", "", "A02", 200.0, 200.0, "john snow", "notebook" },
                    { 3, 2, "the kit for science lab", "", "A03", 150.0, 150.0, "john cena", " Science lab kit" },
                    { 4, 2, "laptop in a very good condition. acer aspire 5 250GB ssd, 1 tb HDD, intel5 7gen 4 GB graphics  ", "", "A04", 40000.0, 39000.0, "billie", "Laptop" }
                });
