...
namespace CampusDeal.DataAccess.Migrations
{
    ...
    [Migration("20231017052737_repportGenerate")]
    partial class repportGenerate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampusDeal.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CampusDeal.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CampusDeal.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CampusDeal.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CampusDeal.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CampusDeal.Models.OrderDetail", b =>
                {
                    b.HasOne("CampusDeal.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("CampusDeal.Models.OrderHeader", b =>
                {
                    b.HasOne("CampusDeal.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CampusDeal.Models.Report", b =>
                {
                    b.HasOne("CampusDeal.Models.OrderDetail", "OrderDetail")
                        .WithMany()
